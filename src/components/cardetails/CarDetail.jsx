...
const CarDetails = () => {
    ...
    return (
        <div className="slider-container pt-20">
            <Slider {...settings}>
                <div key="1"><img className={'image-slide'} src={`https://ash2521.pythonanywhere.com/${car.img_front}`} alt="Car 1" /></div>
                <div key="2"><img className={'image-slide'} src={`https://ash2521.pythonanywhere.com/${car.img_back}`} alt="Car 2" /></div>
                <div key="3"><img className={'image-slide'} src={`https://ash2521.pythonanywhere.com/${car.salon}`} alt="Car 3" /></div>
            </Slider>
            ...
            <div className="p-6 mx-14 border-2 mt-32">
                <CommentSection/>
            ...
            <div id={'rent'} className="mx-14 text-white p-6 border flex justify-around my-20">
                <div className={'flex flex-col justify-center gap-4'}>
                    ...
                    <h3 className="text-4xl font-bold mb-2">{car.make} {car.model}</h3>
                ...
                <form className="space-y-4">
                    ...
                    <select
                        className="w-full p-4 bg-transparent border border-white-700 focus:outline-none"
                    >
                        <option className={'bg-blend-darken'} value="Москва">Бишкек</option>
